...
// TIJ4 Chapter Innerclasses, Exercise 24, page 245
/* In GreenhouseControls.java, add Event inner classes that turn fans on
 * and off. Configure GreenhouseController.java to use thes new Event
 * objects.
 */
