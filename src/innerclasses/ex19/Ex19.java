// innerclasses/ex19/Ex19.java
// TIJ4 Chapter Innerclasses, Exercise 19, page 235
/* Cate a class containing an inner class that itself contains an inner
 * class. Repeat this using nested clases. Note the names of the .class
...
public class Ex19 {
    ...
    private static class Ex19Nested {
        ...
        private static class Ex19NestedNested {
            Ex19NestedNested() {
                System.out.println("Ex19NesteNested()");
            }
        }
    }
