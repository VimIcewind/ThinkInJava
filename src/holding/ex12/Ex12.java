...
/* Create and populate a List<Integer>. Create a second List<Integer> of
 * the same size as the first, and use ListIterator to read elements of
 * the first List and insert them into the second in reverse order. (You
 * may want to explore a number of different ways to solve this problem.)
 */
