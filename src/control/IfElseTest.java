// control/IfElseTest.java
// TIJ4 Chapter Control, Exercise 6, page 144
// Modify the two test() methods in the previous two programs so that they take
// two extra argument begin and end, and so that testval is tested to see if it
// is within the range between (and include) begin and end.
